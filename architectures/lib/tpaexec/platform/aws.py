...
class aws(Platform):
    ...
    def image(self, label, **kwargs):
        ...
        if label in ['debian', 'debian-minimal']:
            image['name'] = 'debian-stretch-hvm-x86_64-gp2-2018-04-09-292'
            image['owner'] = '379101102735'
            image['user'] = 'admin'
        elif label in ['redhat', 'redhat-minimal']:
            image['name'] = 'RHEL-7.4_HVM_GA-20170808-x86_64-2-Hourly2-GP2'
            image['owner'] = '309956199498'
            image['user'] = 'ec2-user'
        elif label in ['ubuntu', 'ubuntu-minimal']:
            image['name'] = 'ubuntu/images/hvm-ssd/ubuntu-xenial-16.04-amd64-server-20180228.1'
