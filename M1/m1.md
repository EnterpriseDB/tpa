...
can be created in the other datacenter, as shown in Figure
\ref{ha-2b}.

![Option: Two Barman Nodes\label{ha-2b}](cache/2b.png){ width=85% }

The two Barman nodes can operate independently of each other, meaning
that no particular coordination between them is needed.
